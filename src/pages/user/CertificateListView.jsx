...
import "../../index.css";
import NotFoundPage from '../not_found/NotFoundPage.jsx';
    ...
    <div className="w-full bg-bg   flex flex-col">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: ` 0 0px 100px 30px ${shadowColor[theme]} inset`,
        }}
      >
        <div
          style={{
            backgroundImage: `linear-gradient(to top, ${shadowColor[theme]}, rgba(0, 0, 0, 0)), url(${merchBg})`,
