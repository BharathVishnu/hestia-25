  ...
  return (
    <div className="home flex flex-col  w-screen h-auto">
      ...
      <div className="relative w-screen h-4 md:h-12">
        ...
        <div className='flex flex-row justify-between border border-white p-2  h-16 mt-4 ' style={{
        ...
        <div className='flex flex-row justify-between border border-white p-2 w-auto h-16 mt-4 ' style={{
          clipPath: "polygon(0 0, 100% 0, 100% 45%,85% 100%, 0 100%)",
        }}>
          <div
            className="relative w-full h-full flex flex-row justify-between items-center font-poppins gap-12 bg text-white px-4 bg-[#720A08]"
        ...
        <div className='flex flex-row justify-between border border-white p-2  h-16 mt-4 w-auto ' style={{
          clipPath: "polygon(0 0, 100% 0, 100% 45%,85% 100%, 0 100%)",
        }}>
          <div
            className="relative w-full h-full flex flex-row justify-between items-center font-poppins gap-12 bg text-white px-4 bg-[#720A08]"
