          ...
          <div className="w-full   md:text-justify md:w-1/2 flex flex-col">
            ...
            <div className="w-full h-1/6 flex flex-col items-center justify-center font-bold text-small ">
              {eventDetails.event_category === "PR" &&
                <div className="border border-red-400 rounded-xl px-2 py-1 flex flex-col mt-10 text-xs items-center">   <h1>Disclaimer!</h1>
                  <p>Pro show tickets are for Students Only</p></div>}
              <button
                // disabled={true}
                disabled={disabled}
                type="submit"
