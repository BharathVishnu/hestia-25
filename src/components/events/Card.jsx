...
function EventCard({ event, index ,img,onClick}) {
  ...
  return (
    <div
      className={`group p-2 w-56 md:w-full h-auto flex flex-col justify-between hover:bg-white  hover:border-white transition-all duration-300
...
function Card() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16 p-4 mb-6">
